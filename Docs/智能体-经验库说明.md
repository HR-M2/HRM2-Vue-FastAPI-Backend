...
└─────────────────────────────────────────────────────────────────┘
                                ...
                                ▼
┌─────────────────────────────────────────────────────────────────┐
│  1. 构建检索上下文: "综合分析 - 岗位: Java后端工程师"            │
└─────────────────────────────────────────────────────────────────┘
                                │
                                ▼
┌─────────────────────────────────────────────────────────────────┐
│  2. exp_manager.recall(db, "analysis", context, top_k=5)        │
│     ├── Embedding 粗召回 → 10条候选                              │
│     └── Reranker 精排 → 5条高相关经验                            │
└─────────────────────────────────────────────────────────────────┘
                                │
                                ▼
┌─────────────────────────────────────────────────────────────────┐
│  3. format_experiences_for_prompt(experiences)                  │
│     → "【重要：以下是过往积累的评估经验...】\n1. xxx\n2. xxx..."  │
└─────────────────────────────────────────────────────────────────┘
                                │
                                ▼
┌─────────────────────────────────────────────────────────────────┐
│  4. 注入到简历内容前面                                           │
│     resume_content = experience_guidance + "\n---\n" + 原简历    │
└─────────────────────────────────────────────────────────────────┘
                                │
                                ▼
┌─────────────────────────────────────────────────────────────────┐
│  5. AnalysisService.analyze(resume_content=增强后的内容)         │
│     └── LLM 在评估时会参考这些经验规则                           │
└─────────────────────────────────────────────────────────────────┘
                                │
                                ▼
┌─────────────────────────────────────────────────────────────────┐
│  6. 返回结果，记录 applied_experience_ids 用于追溯               │
└─────────────────────────────────────────────────────────────────┘
```

### 经验注入示例

格式化后的经验文本会作为 Prompt 前缀注入：

```
【重要：以下是过往积累的评估经验，请在本次评估中严格遵守】
1. Java候选人如果能清晰解释JVM内存模型和GC调优经验，说明基础扎实，应加分
2. 面试Java开发候选人时，应重点追问分布式系统实战经验
3. 后端开发候选人应能清晰描述数据库优化经验
4. 后端候选人对微服务架构的理解很重要
5. 候选人展现出的学习能力和成长潜力，有时比当前技能水平更重要
